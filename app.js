...
function renderDatabasePlayers() {
  ...
  databaseCount.textContent = totalPlayers > 10 ? `10 visÃ­veis de ${totalPlayers}` : `${totalPlayers} cadastrados`;
